...
def figure13_star_percentage_2T():
    ...
    b2=[0.502786,0.502387,0.400617,0.388343]
    b3=[0.502626,0.502726,0.344487,0.35819]
    ...
    plt.bar(lableCall+0.2, b3, label="PDR", color="c", hatch=".",align="center", width=0.2)
...
def figure13_star_percentage_3T():
    ...
    b2 = [0.360722,0.346866,0.285408,0.297552]
    b3 = [0.336833,0.320952,0.222387,0.251486]

    plt.bar(lableCall - 0.2, b1, label="No Modification", color="b", hatch="-",
            align="center", width=0.2)
    plt.bar(lableCall, b2, label="PWR", color="r", hatch="X", align="center",
            width=0.2)
    plt.bar(lableCall + 0.2, b3, label="PDR", color="c", hatch=".", align="center",
            width=0.2)
...
def star_lifetime():
    ...
    b2 = [2321528,2085478, 1008054,1484133]
    b3 = [1845347,1792095,900753,1200381]

    plt.figure(figsize=(8, 4))
    plt.bar(lableCall - 0.2, b1, label="No Modification", color="m", hatch="X", align="center", width=0.2)
    plt.bar(lableCall, b2, label="PWR", color="y", hatch="+", align="center", width=0.2)
    plt.bar(lableCall + 0.2, b3, label="PDR", color="c", hatch="/", align="center", width=0.2)
